...
import '../../view_model/archive_bloc/archive_bloc.dart';
import '../../view_model/archive_bloc/archive_states.dart';


class ArchiveDashboardScreen extends StatelessWidget {
  ArchiveDashboardScreen({Key? key}) : super(key: key);
  var pageController= PageController();
  @override
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        ArchiveCubit.get(context).getAllArchivedReports();
        return Scaffold(
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                BlocConsumer<ArchiveCubit, ArchiveStates>(
                  ...
                  builder: (context, state){
                    return Expanded(
                      child: PageView.builder(
                        itemCount: ArchiveCubit.get(context).reportsScreens.length,
                        controller: pageController,
                        itemBuilder: (context, index)=> ArchiveCubit.get(context).reportsScreens[index],
                        onPageChanged: (index){
                          ArchiveCubit.get(context).changeReportsScreenType(index);
                        },
                      ),
                    );
                  },
