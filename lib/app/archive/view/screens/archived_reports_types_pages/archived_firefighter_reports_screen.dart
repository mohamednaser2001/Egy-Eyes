...
class ArchivedFireFighterReportsScreen extends StatelessWidget {
  ArchivedFireFighterReportsScreen({Key? key,}) : super(key: key);
    ...
    return BlocConsumer<ArchiveCubit, ArchiveStates>(
      ...
      builder: (context, state){
        ...
        return ConditionalBuilder(
            ...
            fallback: (context) {
              return ConditionalBuilder(
                condition: cubit.fireFighterReports.isEmpty,
                builder:(context)=> const EmptyScreen(text: 'There are no firefighter reports yet'),
                fallback: (context)=> GridView.count(
                  ...
                  children: List.generate(
                    cubit.fireFighterReports.length,
                        (index) => ArchivedReportCart(reportModel: cubit.fireFighterReports[index]),
                  ),
                ),
              );
            }
