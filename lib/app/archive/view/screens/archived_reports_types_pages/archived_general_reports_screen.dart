...
class ArchivedGeneralReportsScreen extends StatelessWidget {
  ArchivedGeneralReportsScreen({Key? key,}) : super(key: key);
    ...
    return BlocConsumer<ArchiveCubit, ArchiveStates>(
      ...
      builder: (context, state){
        ...
        return ConditionalBuilder(
            ...
            fallback: (context) {
              return ConditionalBuilder(
                condition: cubit.generalReports.isEmpty,
                builder:(context)=> const EmptyScreen(text: 'There are no general reports yet'),
                fallback: (context)=> GridView.count(
                  ...
                  children: List.generate(
                    cubit.generalReports.length,
                        (index) => ArchivedReportCart(reportModel: cubit.generalReports[index]),
                  ),
                ),
              );
            }
