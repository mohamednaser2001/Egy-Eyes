...
class GeneralReportsScreen extends StatelessWidget {
  GeneralReportsScreen({Key? key,}) : super(key: key);
        ...
        return ConditionalBuilder(
            ...
            fallback: (context) {
              return ConditionalBuilder(
                ...
                builder:(context)=> const EmptyScreen(text: 'There is no general reports yet'),
                fallback: (context)=> GridView.count(
                  ...
                  children: List.generate(
                    cubit.generalReports.length,
                        (index) => ReportCart(reportModel: cubit.generalReports[index]),
                  ),
                ),
              );
            }
