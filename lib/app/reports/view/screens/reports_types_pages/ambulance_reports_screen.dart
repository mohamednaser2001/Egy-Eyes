...
class AmbulanceReportsScreen extends StatelessWidget {
  AmbulanceReportsScreen({Key? key,}) : super(key: key);
      ...
      builder: (context, state){
        ...
        return ConditionalBuilder(
          ...
          fallback: (context)=> ConditionalBuilder(
              ...
              builder: (context)=> const EmptyScreen(text: 'There is no ambulance reports yet'),
              fallback: (context) {
                return GridView.count(
                  ...
                  children: List.generate(
                    cubit.ambulanceReports.length,
                        (index) => ReportCart(reportModel: cubit.ambulanceReports[index]),
                  ),
                );
              }
          ),
