...
class FireFighterReportsScreen extends StatelessWidget {
  FireFighterReportsScreen({Key? key,}) : super(key: key);
        ...
        return ConditionalBuilder(
            ...
            fallback: (context) {
              return ConditionalBuilder(
                ...
                builder:(context)=> const EmptyScreen(text: 'There is no firefighter reports yet'),
                fallback: (context)=> GridView.count(
                  ...
                  children: List.generate(
                    cubit.fireFighterReports.length,
                        (index) => ReportCart(reportModel: cubit.fireFighterReports[index]),
                  ),
                ),
              );
            }
