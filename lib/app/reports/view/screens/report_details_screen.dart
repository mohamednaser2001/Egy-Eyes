...
class ReportDetailsScreen extends StatelessWidget {
  ...
  void initControllers(){
    ...
    senderIdController.text= report.senderId??'30102151402548';
    ...
    senderNameController.text= report.senderName??'Mohamed Nasser';
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomButton(
                              ...
                              elevation: 0.0,
                              function: (){
                                SupportCubit.get(context).sendSupport(report);
                          }),
                          const SizedBox(height: 4.0,),
                          BlocConsumer<SupportCubit, SupportStates>(
                            listener: (context, state){},
                            builder:(context, state)=>SupportCubit.get(context).isSupportSent? const LinearProgressIndicator(color: AppColors.primaryColor,): const SizedBox(),
                          ),
                          //SizedBox(height: 30.0.h,),
                          ...
                          CustomButton(
                              ...
                              elevation: 0.0,
                              function: (){
                                SupportCubit.get(context).sendFake(report);
                              }),
                          const SizedBox(height: 4.0,),
                          BlocConsumer<SupportCubit, SupportStates>(
                            listener: (context, state){},
                            builder:(context, state)=>SupportCubit.get(context).isFakeSent? const LinearProgressIndicator(color: AppColors.primaryColor,): const SizedBox(),
                          ),
                        ],
                      ),
                    ),
