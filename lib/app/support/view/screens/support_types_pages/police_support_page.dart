...
class PoliceSupportPage extends StatelessWidget {
  PoliceSupportPage({Key? key}) : super(key: key);
        ...
        return BlocConsumer<SupportCubit, SupportStates>(
          ...
          builder: (context, state){
            ...
            return ConditionalBuilder(
              condition: cubit.policeSupports.isEmpty,
              builder: (context)=> const EmptyScreen(text: 'There are no police supports yet'),
              fallback:(context)=> GridView.count(
                ...
                children: List.generate(
                  cubit.policeSupports.length,
                      (index) => SupportCart(support: cubit.policeSupports[index],),
                ),
              ),
            );
          },
