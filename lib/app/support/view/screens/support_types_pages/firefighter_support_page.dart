...
import 'package:egy_eye_admin/app/support/view/widgets/support_cart.dart';
...
class FireFighterSupportPage extends StatelessWidget {
  FireFighterSupportPage({Key? key}) : super(key: key);
        ...
        return BlocConsumer<SupportCubit, SupportStates>(
          ...
          builder: (context, state){
            ...
            return ConditionalBuilder(
              condition: cubit.firFighterSupports.isEmpty,
              builder: (context)=> const EmptyScreen(text: 'There are no firefighter support yet'),
              fallback:(context)=> GridView.count(
                ...
                children: List.generate(
                  cubit.firFighterSupports.length,
                      (index) => SupportCart(support: cubit.firFighterSupports[index],),
                ),
              ),
            );
          },
